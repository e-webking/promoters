...
/**
 * Test case for class \ARM\Armconstructions\Domain\Model\Landlord.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class LandlordTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \ARM\Armconstructions\Domain\Model\Landlord();
	}
